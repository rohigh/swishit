    ...
    <div className="min-h-screen bg-[#FBF7EC] text-text flex flex-col font-body selection:bg-[#1D7E9E] selection:text-white">
      ...
      <section className="relative pt-36 pb-16 md:pt-44 md:pb-24 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-[#F5EFD8]/60 to-[#FBF7EC] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <motion.h1
            ...
            className="font-heading text-fluid-4xl font-semibold leading-[1.1] text-text mb-6 tracking-tight"
          >
            Contact <span className="italic font-serif text-text">SWISH IT</span>
          </motion.h1>
      ...
      <section className="pb-24 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            <h2 className="font-heading text-fluid-xl text-text font-bold mb-2">
              Send Us a Message
            </h2>
            <p className="text-text text-sm md:text-base font-medium mb-8">
            ...
            <AnimatePresence mode="wait">
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="font-heading text-2xl text-text font-bold">
                    Message Received!
                  </h3>
                  <p className="text-text text-sm md:text-base font-medium max-w-md mx-auto">
                    Thank you for reaching out to SWISH IT. Our customer care team will review your message and reply shortly.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    className="mt-4 px-6 py-2.5 rounded-full bg-[#155E78] text-white font-bold text-xs uppercase tracking-wider hover:bg-[#122A33] transition-colors shadow-sm"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Full Name */}
                    <div>
                      <label className="block text-xs font-mono uppercase tracking-wider text-text font-bold mb-2">
                      ...
                      <input
                        ...
                        className="w-full bg-[#FBF7EC] border-2 border-[#1D7E9E]/25 rounded-xl px-4 py-3 text-sm text-text font-medium placeholder:text-text/50 focus:outline-none focus:border-[#1D7E9E] focus:bg-white transition-colors"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-[#FBF7EC] border-2 border-[#1D7E9E]/25 rounded-xl px-4 py-3 text-sm text-text font-medium focus:outline-none focus:border-[#1D7E9E] focus:bg-white transition-colors cursor-pointer"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#FBF7EC] border-2 border-[#1D7E9E]/25 rounded-xl px-4 py-3 text-sm text-text font-medium placeholder:text-text/50 focus:outline-none focus:border-[#1D7E9E] focus:bg-white transition-colors resize-none"
                    />
                  </div>
          ...
          >
            ...
            <div className="bg-white rounded-3xl p-8 border border-[#1D7E9E]/20 shadow-md space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-heading text-xl text-text font-bold">Hours & Availability</h4>
                  <p className="text-xs text-text font-medium">Fast support Monday through Friday</p>
                </div>
              </div>
              ...
              <div className="divide-y divide-gray-100 text-sm pt-2">
                <div className="py-2.5 flex justify-between">
                  ...
                  <span className="font-bold text-text">9:00 AM – 6:00 PM EST</span>
                </div>
                <div className="py-2.5 flex justify-between">
                  <span className="text-text font-medium">Saturday & Sunday</span>
                  <span className="font-bold text-text">Email Only</span>
                </div>
                <div className="py-2.5 flex justify-between">
                  <span className="text-text font-medium">Response Guarantee</span>
            ...
            <div className="bg-[#E8F5F8] rounded-3xl p-8 border border-[#1D7E9E]/25 text-center space-y-3 shadow-sm">
              ...
              <h4 className="font-heading text-xl text-text font-bold">The SWISH IT Care Standard</h4>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-20 bg-[#F5EFD8]/60 border-t border-[#1D7E9E]/15">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="font-heading text-fluid-xl text-text font-semibold">
            Frequently Asked Questions
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-[#1D7E9E]/20 shadow-md">
              <h4 className="font-bold text-text text-lg mb-2">How fast do orders ship?</h4>
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-[#1D7E9E]/20 shadow-md">
              <h4 className="font-bold text-text text-lg mb-2">Do you offer bulk commercial supply?</h4>
              <p className="text-sm text-text leading-relaxed font-medium">
          ...
          <div className="pt-2">
            <Link href="/#faq" className="text-sm font-bold text-text hover:text-text hover:underline">
