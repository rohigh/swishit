...
class Media {
  ...
  createShader() {
    ...
    img.onerror = () => {
      // Fallback if image CORS gets blocked
      const fallbackImg = new Image();
      fallbackImg.src = "/img/ocean garden edited.png";
      fallbackImg.onload = () => {
...
class App {
  ...
  createMedias(items, bend, textColor, borderRadius, font) {
    const defaultItems = [
      { image: "/img/ocean garden edited.png", text: "Ocean Garden Dew" },
      { image: "/img/lime lush edited.png", text: "Lime Lush Dew" },
      { image: "/img/lemon edited.png", text: "Lemon Loop Dew" },
    ];
